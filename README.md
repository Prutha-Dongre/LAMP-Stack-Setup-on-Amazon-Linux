...
```
![start, ebable Apache (httpd)](5-2.png)
...
```
![Install MariaDB](6-1.png)

```bash
sudo systemctl start mariadb
sudo systemctl enable mariadb
```
![start, ebable mariadb](6-2.png)
...
```
![Install FPM, start,enabe php-fpm](7-2.png)
---
### ✔ STEP 8:- Check Service Status
```bash
sudo systemctl status httpd mariadb php-fpm
```
![Check Service Status](8.png)
...
?>
```
![Create HTML and PHP Page](9.png)
